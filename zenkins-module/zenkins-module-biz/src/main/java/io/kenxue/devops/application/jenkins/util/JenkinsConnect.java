package io.kenxue.devops.application.jenkins.util;
...
public class JenkinsConnect {
    ...
    // 连接 Jenkins 需要设置的信息
    static final String JENKINS_URL = "http://192.168.143.131:8080/";
    static final String JENKINS_USERNAME = "root";
    static final String JENKINS_PASSWORD = "11762610a532ab126da3f107ec7f77b40a";
