...
<script>
import {add, del, testConn, get, page, update, addSecret} from '@/api/system/machine/machine'
import {list as getGroupList} from "@/api/system/machine/group"
import {nestedGetQuery} from "@/utils";
import Xterm from "@/views/system/machine/xterm";
...
export default {
  ...
  methods: {
    ...
    initSocket(uuid, id) {
      ...
      this.socket = new WebSocket('ws://127.0.0.1:48080/ws/terminal?' + uuid);
      this.socketOnClose();
